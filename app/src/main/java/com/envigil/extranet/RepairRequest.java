           ...
           // System.out.println("Postleak ::"+postleak);
            ...
            /*pickedTime.compareTo(repairDateTime2) < 0*/
                ...
                if(new SQLiteHelper(getApplicationContext()).isLeakIDIsPresent(LeakId)){
                    ...
                    Timber.e("Update Leak Repair LeakId="+LeakId+",EmpID="+empId+",leakRepairTypeId="+leakRepairTypeId+",leakRepairRate="+leakRepairRate+",dateTime="+dateTime);
                ...
                sqLiteHelper.InsertLeakRepair(LeakRepairId,LeakId,empId,leakRepairTypeId,leakRepairRate,dateTime);
                    Timber.e("Insert Leak Repair LeakId="+LeakId+",EmpID="+empId+",leakRepairTypeId="+leakRepairTypeId+",leakRepairRate="+leakRepairRate+",dateTime="+dateTime);
                //&& dateTime.compareTo(datetimeLeak) < 0
                AlertDialog.Builder builder = new AlertDialog.Builder(RepairRequest.this);
                builder.setCancelable(false);
                builder.setTitle("Repair Request Successful");
...
//                } else
                ...
                {
                    Timber.e("(Reapir Request)Click on inspect route");
                    ...
                    Timber.e("(Reapir Request)Click on download route");
...
//                    startActivity(new Intent(ComponentDashboard.this,HomeActivity.class));
                    ...
                    Timber.e("(Reapir Request)Click on upload route");
//                    fraglayout.setCurrentItem(0);
                    ...
                    Timber.e("(Reapir Request)Click on TVA Connect");
...
//                    Toast.makeText(getApplicationContext(),"Redirecting to bluetooth configuration",Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        if(leakedit_Flag){
            Timber.e("'Repair Request' Back pressed go to show leaks");
            startActivity(new Intent(RepairRequest.this,ShowLeaksActivity.class).putExtra("RouteID",RouteID));
            finish();
            leakedit_Flag=false;
        }else {
            Timber.e("'Repair Request' Back pressed go to LeakReportActivity");
