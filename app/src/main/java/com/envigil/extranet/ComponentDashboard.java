            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                int menuId = item.getItemId();
                    if (menuId == R.id.inspect_routes) {
                        Timber.e("(CompDashBoard Drawer) open inspect routes");
                    ...
                    drawerLayout.closeDrawer(GravityCompat.START);
                        ...
                        Timber.e("(CompDashBoard Drawer) open download routes");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    ...
                    drawerLayout.closeDrawer(GravityCompat.START);
                        ...
                        Timber.e("(CompDashBoard Drawer) open upload routes");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    finish();
                    drawerLayout.closeDrawer(GravityCompat.START);
                        ...
                        Timber.e("(CompDashBoard Drawer) open TVA Connect");
