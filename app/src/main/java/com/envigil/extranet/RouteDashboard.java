        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (menuId == R.id.inspect_routes){
                    Timber.e("(RouteDash Drawer)Click on inspect route");
                    ...
                    Timber.e("(RouteDash Drawer)Click on Download route");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    ...
                    Timber.e("(RouteDash Drawer)Click on Upload route");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    finish();
                    ...
                    Timber.e("(RouteDash Drawer)Click on TVA Connect");
