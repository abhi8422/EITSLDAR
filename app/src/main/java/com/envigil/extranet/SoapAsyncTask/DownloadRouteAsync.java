...
public class DownloadRouteAsync extends AsyncTask {
    ...
    static {
        ...
        try {
            ...
            dayFolder= folder+File.separator +format.format(Calendar.getInstance().getTime());
            logfile = new File(dayFolder, "DownloadLog"+System.currentTimeMillis()+".txt");
    ...
    public DownloadRouteAsync(String name, Context context, int routeID, int workorderID) {
        ...
        Timber.e("Downlaoding Route:"+routeID);
    }
    ...
    public class AsynLock extends AsyncTask {
       ...
       @Override
        protected void onPostExecute(Object o) {
            super.onPostExecute(o);
            if (!LResult){
                Timber.e("Problem in Route Downloading 'Result is false'");
                ...
                alertDialog1.show();
                Timber.e("if(result.equals()) Calling AsynD() to setn'D' ");
                logger.info("if(result.equals()) Calling AsynD() to setn'D' ");
                new AsynD().execute();
            }
            if (result.trim().equals("")) {
                Timber.e("Problem in Route Downloading 'result is empty'");
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                alertDialogBuilder.setMessage("There is problem with route downloading");
                alertDialogBuilder.setNegativeButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                ...
                try {
                    ...
                    exception=true;
                    Timber.e("Json Pasrsing Exception"+writer.toString());
        ...
        public class AsynInsert extends AsyncTask {
            ...
            protected void onPostExecute(Object o) {
                ...
                if (IResult){
                    ...
                    AlertDialog alertDialog1 = alertDialogBuilder.create();
                    alertDialog1.show();
                    Timber.e("Calling AsynD() after deleting table");
