...
//                    tvComponent.setText();
                        ...
                        compId=componentsListPojo.getCompID();
...
//            Toast.makeText(ComponentReading.this, "InvOrder :: "+invOrder, Toast.LENGTH_SHORT).show();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Timber.e("Click on Previous Button '<<' ");
                max=0.0;
...
//Save Button.
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Timber.e("(CompReading)Click on button save");
                max=0.0;
...
*/
                ...
                if (!reasonSpinner.getSelectedItem().toString().trim().equals("Select Skip Reason") && (edReading.getText().toString().trim().equals(""))){
                    ...
                    if (inspected.equals("true")|| inspected.equals("1")){
                        ...
                        builder.setMessage("Do you want to proceed ?")
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Timber.e("Skip reason is selected for already inpsected comp="+SelectedReasonSkippedId+",SubID="+SubID
                                        +",InvId="+InvId+",RouteId="+RouteId);
                        ...
                        sqLiteHelper.UpdateReasonSkippedID(RouteId,SubID,InvId,SelectedReasonSkippedId);
                        Timber.e("Skip reason is selected for comp="+SelectedReasonSkippedId
                        +",SubId="+SubID+",InvId"+InvId+",RouteId="+RouteId);
                        // Update RouteConfig Inspected Flag
                        int countRouteInsp = 0;
                        countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                        if (countRouteInsp == 0) {
                                        ...
                                        PermId = sqLiteHelper.CheckPermId(FacId[0]);
                                            ...
                                            if (PermOrLeak) {
                                                if (Reading > PermStartRate) {
                                                    ...
                                                    Timber.e("(Reading > PermStartRate) Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                                    // Update RouteConfig Inspected Flag
                                                    int countRouteInsp = 0;
                                                    countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                                    if (countRouteInsp == 0) {
                                                    ...
                                                    builder.setMessage("Navigating to Leak Summary ")
                                                            ...
                                                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                public void onClick(DialogInterface dialog, int id) {
                                                                    startActivity(new Intent(ComponentReading.this, LeakReportActivity.class).
                                                                            putExtra("CompId", compId).
                                                                            putExtra("SubId", SubID).
                                                                            putExtra("LeakRate", Reading).
                                                                            putExtra("Unit", Unit).
                                                                            putExtra("RouteID", RouteId).
                                                                            putExtra("InvID", InvId).
                                                                            putExtra("PermOrLeak", PermOrLeak).
                                                                            putExtra("last", last).
                                                                            putExtra("Grid",grid));
                                                                    Timber.e("Navigate To Leak Summary CompId="+compId+",SubId="+ SubID+",LeakRate="+Reading+
                                                                            ",Unit="+ Unit+ ",RouteID="+RouteId+ ",InvID="+InvId+ ",PermOrLeak="+PermOrLeak+",last"+last+
                                                                            ",Grid="+grid);
                                                                    finish();
                                                                    dialog.cancel();
                                                                }
                                                    ...
                                                    sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading,SelectedReasonSkippedId);
                                                    Timber.e("(Reading > PermStartRate 'else')UpdateComp Reading RouteID="+RouteId+",SubID="+ SubID+",InvId="+ InvId+",Reading="+ Reading+",SelectedReasonSkippedId="+SelectedReasonSkippedId);
                                                    // Update RouteConfig Inspected Flag
                                                    int countRouteInsp = 0;
                                                    countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                                    if (countRouteInsp == 0) {
                                                ...
                                                if (LeakRateStart == 0.0) {
                                                    ...
                                                    if (LeakRateStartStr > 0.0) {
                                                        if (Reading > LeakRateStartStr) {
                                                            final String Unit = tvunit.getText().toString();
                                                            sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                                            Timber.e("(LeakRateStart>0.0) Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                                            // Update RouteConfig Inspected Flag
                                                            int countRouteInsp = 0;
                                                            countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                                            if (countRouteInsp == 0) {
                                                                    ...
                                                                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                        public void onClick(DialogInterface dialog, int id) {
                                                                            ...
                                                                            startActivity(new Intent(ComponentReading.this, LeakReportActivity.class)
                                                                                    .putExtra("CompId", compId)
                                                                                    .putExtra("SubId", SubID)
                                                                                    .putExtra("LeakRate", Reading).putExtra("Unit", Unit)
                                                                                    .putExtra("RouteID", RouteId).putExtra("InvID", InvId)
                                                                                    .putExtra("PermOrLeak", PermOrLeak).putExtra("last", last)
                                                                                    .putExtra("Grid",grid));
                                                                            Timber.e("Navigate To Leak Summary CompId="+compId+",SubId="+ SubID+",LeakRate="+Reading+
                                                                                    ",Unit="+ Unit+ ",RouteID="+RouteId+ ",InvID="+InvId+ ",PermOrLeak="+PermOrLeak+",last"+last+
                                                                                    ",Grid="+grid);
                                                            ...
                                                            sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                                            Timber.e("(Reading>LeakRateStart'else') Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                                            // Update RouteConfig Inspected Flag
                                                            int countRouteInsp = 0;
                                                            countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                                            if (countRouteInsp == 0) {
                                                    ...
                                                    if (Reading > LeakRateStart) {
                                                        final String Unit = tvunit.getText().toString();
                                                        sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                                        Timber.e("Update CompReading RouteId="+RouteId+",SunID="+SubID+",InvID="+InvId+",Reading ="+ Reading+",SkipReason="+SelectedReasonSkippedId);
                                                        // Update RouteConfig Inspected Flag
                                                        int countRouteInsp = 0;
                                                        countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                                        if (countRouteInsp == 0) {
                                                                ...
                                                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                    public void onClick(DialogInterface dialog, int id) {
                                                                        ...
                                                                        startActivity(new Intent(ComponentReading.this, LeakReportActivity.class)
                                                                                ...
                                                                                .putExtra("SubId", SubID)
                                                                                .putExtra("LeakRate", Reading)
                                                                                .putExtra("Unit", Unit).putExtra("RouteID", RouteId)
                                                                                .putExtra("InvID", InvId).putExtra("PermOrLeak", PermOrLeak)
                                                                                .putExtra("last", last).putExtra("Grid",grid));
                                                                        Timber.e("Navigate To Leak Summary CompId="+compId+",SubId="+ SubID+",LeakRate="+Reading+
                                                                                ",Unit="+ Unit+ ",RouteID="+RouteId+ ",InvID="+InvId+ ",PermOrLeak="+PermOrLeak+",last"+last+
                                                                                ",Grid="+grid);
                                                                        finish();
                        ...
                        PermId = sqLiteHelper.CheckPermId(FacId[0]);
                            ...
                            if (PermOrLeak) {
                                ...
                                if (Reading > PermStartRate) {
                                    final String Unit = tvunit.getText().toString();
                                    sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading,SelectedReasonSkippedId);
                                    Timber.e("(Navigation To Leak Edit)Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                    // Update RouteConfig Inspected Flag
                                    int countRouteInsp = 0;
                                    countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                    if (countRouteInsp == 0) {
                                    ...
                                    sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading,SelectedReasonSkippedId);
                                    Timber.e("Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                    // Update RouteConfig Inspected Flag
                                    int countRouteInsp = 0;
                                    countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                    if (countRouteInsp == 0) {
...
//                                    Toast.makeText(ComponentReading.this, "LeakRateStartStr :: "+LeakRateStartStr, Toast.LENGTH_SHORT).show();
                                    if (LeakRateStartStr > 0.0) {
                                        if (Reading > LeakRateStartStr) {
                                            final String Unit = tvunit.getText().toString();
                                            sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                            Timber.e("(Navigation To Leak Edit)IF Not by Permit Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                            ...
                                            sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                            Timber.e("IF Not by Permit Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                            // Update RouteConfig Inspected Flag
                                            int countRouteInsp = 0;
                                            countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                            if (countRouteInsp == 0) {
                                        ...
                                        sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                        Timber.e("(!LeakRateStartst>0.0)IF Not by Permit Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                        // Update RouteConfig Inspected Flag
                                        int countRouteInsp = 0;
                                        countRouteInsp = sqLiteHelper.getRouteInspCount(RouteId);
                                        if (countRouteInsp == 0) {
                                    ...
                                    if (Reading > LeakRateStart) {
                                        final String Unit = tvunit.getText().toString();
                                        sqLiteHelper.UpdateCompReading(RouteId, SubID, InvId, Reading, SelectedReasonSkippedId);
                                        Timber.e("(Reading > LeakRateStart) Navigate to leak Updating Comp Reading for Route="+RouteId+",SubID="+SubID+",InvId="+InvId+",Reading="+Reading+",SkipReason="+SelectedReasonSkippedId);
                                                ...
                                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int id) {
                                                        ...
                                                        startActivity(new Intent(ComponentReading.this, LeakReportActivity.class)
                                                                ...
                                                                .putExtra("LeakRate", Reading).putExtra("Unit", Unit)
                                                                .putExtra("RouteID", RouteId).putExtra("InvID", InvId)
                                                                .putExtra("PermOrLeak", PermOrLeak).putExtra("last", last).putExtra("Grid",grid));
                                                        Timber.e("Navigate To Leak Summary CompId="+compId+",SubId="+ SubID+",LeakRate="+Reading+
                                                                ",Unit="+ Unit+ ",RouteID="+RouteId+ ",InvID="+InvId+ ",PermOrLeak="+PermOrLeak+",last"+last+
                                                                ",Grid="+grid);
                                                        finish();
...
//                } else
                if (menuId == R.id.inspect_routes) {
                    Timber.e("(cmp reading)click on inspect route");
                    ...
                    Timber.e("(cmp reading)click on download route");
...
//                    startActivity(new Intent(ComponentDashboard.this,HomeActivity.class));
                    ...
                    Timber.e("(cmp reading)click on upload route");
//                    fraglayout.setCurrentItem(0);
                    ...
                    Timber.e("(cmp reading)click on TVA Connect");
...
//                    tvComponent.setText();
            ...
            tvTAG.setText(componentsListPojo.getInvTag());
            InvId=componentsListPojo.getInvID();
            //same compId is going to leak and then come to this activity by adding this it can be sloved
            compId=componentsListPojo.getCompID();
            invOrder = sqLiteHelper.getInvOrder(RouteId,SubID,componentsListPojo.getInvID());
//            Toast.makeText(ComponentReading.this, "InvOrder :: "+invOrder, Toast.LENGTH_SHORT).show();
            break;  //to get out of the FOR loop
