...
//                else
                if (menuId == R.id.inspect_routes){
                    Timber.e("(Comptable drawer) click on inspect route");
                    ...
                    Timber.e("(Comptable drawer) click on download route");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    ...
                    Timber.e("(Comptable drawer) click on upload route");
                    TestRecycler testRecycler=new TestRecycler(sqLiteHelper.getAll());
                    DownloadedWorkOrderFrag.downloadedrecycler.setAdapter(testRecycler);
                    testRecycler.notifyDataSetChanged();
                    finish();
                    ...
                    Timber.e("(Comptable drawer) click on TVA Connect");
