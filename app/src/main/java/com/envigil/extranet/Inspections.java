     ...
     public class async extends AsyncTask{
         ...
         protected Object doInBackground(Object[] objects) {
             ...
             if (result.equals("true")){
                 ...
                 Timber.e("Creating Inspection,workId="+workId+",empId="+empId+",tvaId="+tvaId
                         +",inspStart="+inspStart+",inspEnd="+inspEnd+",inspLunch="+inspLunch+",inspTravel="+inspTravel
                         +",inspAdmin="+inspAdmin+",inspRepair="+inspRepair+",inspReinsp="+inspReinsp);
...
//                else
                ...
                if (menuId == R.id.inspect_routes){
                    Timber.e("(Inspection)Click on insp route");
                    ...
                    Timber.e("(Inspection)Click on download route");
//                    fraglayout.setCurrentItem(1);
                    ...
                    Timber.e("(Inspection)Click on upload route");
//                    fraglayout.setCurrentItem(0);
                    ...
                    Timber.e("(Inspection)Click on TVA Connect");
